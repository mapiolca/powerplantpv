...
/**
 *       \file       htdocs/powerplantpv/ajax/powerplant.php
 *       \brief      File to return Ajax response on powerplant list request
 */
...
dol_syslog("Call ajax powerplantpv/ajax/powerplant.php");
