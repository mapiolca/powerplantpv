...
class modPowerPlantPV extends DolibarrModules
{
	...
	private function seedMaintenanceDictionaryRows($entity)
	{
		...
		$sectionRows = array(
			...
			array('code' => 'CUSTOMER_SIGNATURE', 'label' => 'Signature client', 'label_en' => 'Customer signature', 'description' => 'Signature client gérée par la signature native Dolibarr.', 'description_en' => 'Customer signature handled by native Dolibarr signature.', 'scope_type' => 'intervention', 'equipment_type' => '', 'repeat_mode' => 'once', 'is_base' => 1, 'is_required' => 0, 'active' => 1, 'position' => 999),
		);
	...
	private function seedMaintenanceReportTemplateFields($entity)
	{
		...
		$rows = array(
			...
			array('section' => 'CUSTOMER_SIGNATURE', 'service' => '', 'code' => 'CUSTOMER_SIGNATURE_CAPTURE', 'label' => 'Signature client', 'label_en' => 'Customer signature', 'field_type' => 'signature', 'scope_type' => 'intervention', 'unit' => '', 'position' => 9990),
