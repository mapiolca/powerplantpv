...
/**
 *  \file       htdocs/core/modules/powerplantpv/mod_powerplant_standard.php
 *  \ingroup    powerplantpv
 *  \brief      File of class to manage PowerPlant numbering rules standard
 */
dol_include_once('/powerplantpv/core/modules/powerplantpv/modules_powerplant.php');


/**
 *	Class to manage the Standard numbering rule for PowerPlant
 */
class mod_powerplant_standard extends ModeleNumRefPowerPlant
{
	/**
	...
	public function canBeActivated($object)
	{
		...
		if ($object->ismultientitymanaged == 1 && $this->hasEntityField($db)) {
			$sql .= " AND t.entity IN (".self::getPowerPlantReferenceEntityList($object).")";
			...
			$sql .= " WHERE pt.entity IN (".self::getPowerPlantReferenceEntityList($object).")";
		}
	...
	public function getNextValue($object)
	{
		...
		if ($resql) {
			...
			dol_syslog("mod_powerplant_standard::getNextValue", LOG_DEBUG);
			return -1;
		}
		...
		dol_syslog("mod_powerplant_standard::getNextValue return ".$this->prefix.$yymm."-".$num);
