...
/**
 * \file       htdocs/core/modules/powerplantpv/mod_powerplant_advanced.php
 * \ingroup    powerplantpv
 * \brief      File containing class for advanced numbering model of PowerPlant
 */
...
/**
 *	Class to manage the Advanced numbering rule for PowerPlant
 */
class mod_powerplant_advanced extends ModeleNumRefPowerPlant
{
	/**
	...
	public function info($langs)
	{
		...
		$tooltip .= $langs->trans("GenericMaskCodes4a", $langs->transnoentities("PowerPlant"), $langs->transnoentities("PowerPlant"));
	 ...
	 *
	 *  @param  PowerPlant		$object		Object we need next value for
	...
	public function getNextValue($object)
	{
		...
		$bentityon = true;
		$forceentity = null;
		if ($this->hasEntityField($db)) {
			$bentityon = false;
			$forceentity = self::getPowerPlantReferenceEntityList($object);
		}

		$numFinal = get_next_value($db, $mask, 'powerplantpv_powerplant', 'ref', '', '', $date, 'next', $bentityon, null, $forceentity);
