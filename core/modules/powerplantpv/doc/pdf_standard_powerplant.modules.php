...
/**
 *  \file       core/modules/powerplantpv/doc/pdf_standard.modules.php
...
/**
 *	Class to manage PDF template standard_powerplant
 */
class pdf_standard_powerplant extends ModelePDFPowerPlant
{
	/**
	 ...
	 *
	 *	@param	TCPDF|TCPDI	$pdf     		Object PDF
	 *	@param	PowerPlant	$object     	Object to show
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		if (getDolGlobalString('POWERPLANTPV_DRAFT_WATERMARK') && $object->status == $object::STATUS_DRAFT) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('POWERPLANTPV_DRAFT_WATERMARK')));
		}
