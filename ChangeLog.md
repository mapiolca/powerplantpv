...
- amélioration du modèle PDF de bridage dynamique onduleur : section installation en tableau à hauteur de ligne homogène, matériel réparti par ligne en colonnes catégorie/désignation/numéro de série avec cellules alignées, sans colonne bridage, suppression de la section vérifications, bloc résultat/fait à/signature conservé sur une même page, signataire intégré à la case Signature et footer Dolibarr davantage réservé ;
