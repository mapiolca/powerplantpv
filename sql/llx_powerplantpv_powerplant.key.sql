...
ALTER TABLE llx_powerplantpv_powerplant ADD UNIQUE INDEX uk_powerplantpv_powerplant_ref_entity (ref, entity);
ALTER TABLE llx_powerplantpv_powerplant ADD INDEX idx_powerplantpv_powerplant_entity (entity);
