...
CREATE TABLE IF NOT EXISTS llx_powerplantpv_product_inverter(
	...
	thd varchar(64),
	backup_nominal_power double(24,8),
	backup_peak_power double(24,8),
	backup_peak_duration double(24,8),
	backup_transfer_time double(24,8),
	backup_nominal_voltage varchar(128),
	backup_max_current double(24,8),
	backup_thd varchar(64),
	max_unbalanced_output double(6,3),
