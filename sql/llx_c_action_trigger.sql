...
INSERT INTO llx_c_action_trigger (code, label, description, elementtype, rang)
SELECT 'POWERPLANTPV_POWERPLANT_COMP_SERIAL_IMPORT', 'Import de numéros de série validé', 'Déclenché quand un import de numéros de série est validé.', 'powerplant@powerplantpv', 45000416
FROM DUAL
