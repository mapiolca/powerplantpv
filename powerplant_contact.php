...
/**
 *  \file       powerplant_contact.php
 *  \ingroup    powerplantpv
 *  \brief      Tab for contacts linked to PowerPlant
 */
...
$title = $langs->trans("PowerPlant")." - ".$langs->trans('ContactsAddresses');
//$title = $object->ref." - ".$langs->trans('ContactsAddresses');
$help_url = '';
//$help_url='EN:Module_Third_Parties|FR:Module_Tiers|ES:Empresas';
llxHeader('', $title, $help_url, '', 0, 0, '', '', '', 'mod-powerplantpv page-card_contact');
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("PowerPlant"), -1, $object->picto);
