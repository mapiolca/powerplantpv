...
$item = $formSetup->newItem('POWERPLANTPV_MYPARAM1');
$item->fieldParams['isMandatory'] = 1;
$item->fieldAttr['placeholder'] = (empty($_SERVER['HTTPS']) ? 'http://' : 'https://') . $_SERVER['HTTP_HOST'];
$item->cssClass = 'minwidth500';

// Setup conf for selection of a simple string input
$item = $formSetup->newItem('POWERPLANTPV_MYPARAM2');
$item->defaultFieldValue = 'default value';
$item->fieldAttr['placeholder'] = 'A placeholder here';
$item->helpText = 'Tooltip text';

// Setup conf for selection of a simple textarea input but we replace the text of field title
$item = $formSetup->newItem('POWERPLANTPV_MYPARAM3');
$item->nameText = $item->getNameText().' more html text ';

// Setup conf for a selection of a Thirdparty
$item = $formSetup->newItem('POWERPLANTPV_MYPARAM4');
$item->setAsThirdpartyType();

// Setup conf for a selection of a boolean
$formSetup->newItem('POWERPLANTPV_MYPARAM5')->setAsYesNo();	 // ->fieldParams['alertifoff'] = 1 or ->fieldParams['alertifon'] = 1;

// Setup conf for a selection of an Email template of type thirdparty
$formSetup->newItem('POWERPLANTPV_MYPARAM6')->setAsEmailTemplate('thirdparty');

// Setup conf for a selection of a secured key
//$formSetup->newItem('POWERPLANTPV_MYPARAM7')->setAsSecureKey();

// Setup conf for a selection of a Product
$formSetup->newItem('POWERPLANTPV_MYPARAM8')->setAsProduct();
...
$formSetup->newItem('POWERPLANTPV_MYPARAM9')->setAsSelect($TField);

// Setup conf for a multiselect combo list
$item = $formSetup->newItem('POWERPLANTPV_MYPARAM10');
$item->setAsMultiSelect($TField);
$item->helpText = $langs->transnoentities('POWERPLANTPV_MYPARAM10');

// Setup conf for a category selection
$formSetup->newItem('POWERPLANTPV_CATEGORY_ID_XXX')->setAsCategory('product');

// Setup conf POWERPLANTPV_MYPARAM10
$item = $formSetup->newItem('POWERPLANTPV_MYPARAM10');
$item->setAsColor();
...
$item = $formSetup->newItem('POWERPLANTPV_MYPARAM11')->setAsHtml();
$item->nameText = $item->getNameText().' more html text ';
$item->fieldInputOverride = '';
$item->helpText = $langs->transnoentities('HelpMessage');
$item->cssClass = 'minwidth500';

$item = $formSetup->newItem('POWERPLANTPV_MYPARAM12');
$item->fieldOverride = "Value forced, can't be modified";
$item->cssClass = 'minwidth500';

//$item = $formSetup->newItem('POWERPLANTPV_MYPARAM13')->setAsDate();	// Not yet implemented
...
print dol_get_fiche_head($head, 'settings', $langs->trans($title), -1, "powerplantpv@powerplantpv");
