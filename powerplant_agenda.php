...
/**
 *  \file       powerplant_agenda.php
 *  \ingroup    powerplantpv
 *  \brief      Tab of events on PowerPlant
 */
...
if ($object->id > 0) {
	$title = $langs->trans("PowerPlant")." - ".$langs->trans('Agenda');
	//$title = $object->ref." - ".$langs->trans("Agenda");
	$help_url = 'EN:Module_Agenda_En|DE:Modul_Terminplanung';

	llxHeader('', $title, $help_url, '', 0, 0, '', '', '', 'mod-powerplantpv page-card_agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("PowerPlant"), -1, $object->picto);
