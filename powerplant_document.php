...
/**
 *  \file       powerplant_document.php
 *  \ingroup    powerplantpv
 *  \brief      Tab for documents linked to PowerPlant
 */
...
if ($enablepermissioncheck) {
	...
	$permissiontoadd  = $user->hasRight('powerplantpv', 'powerplant', 'write'); // Used by the include of actions_addupdatedelete.inc.php and actions_linkedfiles.inc.php
} else {
	$permissiontoread = 1;
	$permissiontoadd  = 1;
}
...
// Header
// ------
$title = $langs->trans("PowerPlant")." - ".$langs->trans("Files");
//$title = $object->ref." - ".$langs->trans("Files");
$help_url = '';
//Example $help_url='EN:Module_Third_Parties|FR:Module_Tiers|ES:Empresas';
llxHeader('', $title, $help_url, '', 0, 0, '', '', '', 'mod-powerplantpv page-card_document');

// Show tabs
$head = powerplantPrepareHead($object);

print dol_get_fiche_head($head, 'document', $langs->trans("PowerPlant"), -1, $object->picto);
