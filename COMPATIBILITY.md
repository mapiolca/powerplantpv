...
| Socle données maintenance | v20.0 | Dictionnaires, droits et extrafields utilisent les APIs Dolibarr disponibles en v20. | Le socle est disponible ; les rapports PDF de maintenance restent hors périmètre. |
| Onglet Maintenance centrale et moteur d'échéances | v20.0 | Le calcul s'appuie sur les liens natifs `element_element`, les contrats validés, les lignes de contrat ouvertes, les extrafields de période et les interventions Dolibarr v20. | La prochaine période doit être configurée sur le contrat ; la récurrence est affichée mais ne génère pas encore automatiquement de nouvelles dates. |
| Moteur de modèles de rapports | v20.0 | Les classes métier, tables normalisées et pages d'administration utilisent les APIs Dolibarr disponibles en v20 et PHP 8.0. | L'administration des modèles est disponible ; l'onglet Rapport des interventions et la génération PDF restent hors périmètre. |
